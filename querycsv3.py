...
def qsqldb(sqldb, sql_cmd, outfilename=None):
    ...
    #rowsCount = curs.rowcount
    columnList = [desc[0] for desc in curs.description]
...
def qcsv(infilenames, outfilename, file_db, keep_db, sql_cmd):
    ...
    #
    # Execute the SQL
    return qsqldb(conn, sql_cmd, outfilename)
    #
    # Clean up.
    #conn.close()
